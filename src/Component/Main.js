                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="className-item">
                                <div className="ci-pic">
                                    <img src="img/classes/className-1.jpg" alt="" />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="className-item">
                                <div className="ci-pic">
                                    <img src="img/classes/className-2.jpg" alt="" />
                                </div>
                                <div className="ci-text">
                                    <span>Cardio</span>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="className-item">
                                <div className="ci-pic">
                                    <img src="img/classes/className-3.jpg" alt="" />
                                </div>
                                <div className="ci-text">
                                    <span>STRENGTH</span>
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="className-item">
                                <div className="ci-pic">
                                    <img src="img/classes/className-4.jpg" alt="" />
                                </div>
                                <div className="ci-text">
                                    <span>Cardio</span>
                        ...
                        <div className="col-lg-6">
                            <div className="className-item">
                                <div className="ci-pic">
                                    <img src="img/classes/className-5.jpg" alt="" />
                                </div>
                                <div className="ci-text">
                                    <span>Training</span>
                                    <h4>Boxing</h4>
